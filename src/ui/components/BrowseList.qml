...
Item {
    ...
    ListView {
        ...
        delegate: Item {
            ...
            // The heart survives rapid mode: it is one cached tinted
            // pixmap per row, cheap enough to keep during fast travel
            // (device-validated), and losing it read as rows changing
